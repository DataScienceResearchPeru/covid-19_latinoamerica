...
def load_and_generatecsv(list_date_list):
    ...
    path_csv = os.path.abspath(root_relative+"utils/scripts/data_collection/data2/ecuador_temporal/")

    data_ecuador_confirmed = pd.read_csv(path_ecuador_confirmed_csv, engine='python')
    data_ecuador_deaths = pd.read_csv(path_ecuador_deaths_csv, engine='python')
