...
def load_and_generatecsv(list_date_list):
    ...
    path_csv = os.path.abspath(root_relative+"utils/scripts/data_collection/data2/colombia_temporal/")
    path_per_patient_csv = os.path.abspath(root_relative+'latam_covid_19_data/per_patient/CO.csv')
    data_colombia = pd.read_csv(path_colombia_csv,encoding='latin-1', engine='python')
    # SAVE FILE
    data_colombia.to_csv(path_per_patient_csv,encoding='latin-1', index=False)
