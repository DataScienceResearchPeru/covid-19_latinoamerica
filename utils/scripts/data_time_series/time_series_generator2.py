...
def generate():
    ...
    root_relative = '../../'
    path = os.path.abspath(root_relative+'latam_covid_19_data/daily_reports/')
    ...
    url = os.path.abspath(root_relative+'utils/iso3166-2.csv')
    ...
    confirmed.to_csv(
        os.path.abspath(root_relative+'latam_covid_19_data/time_series/time_series_confirmed.csv'), sep=',', index=False)
    deaths.to_csv(
        os.path.abspath(root_relative+'latam_covid_19_data/time_series/time_series_deaths.csv'), sep=',', index=False)
    recovered.to_csv(
        os.path.abspath(root_relative+'latam_covid_19_data/time_series/time_series_recovered.csv'), sep=',', index=False)
